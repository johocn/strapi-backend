<template>
  <view class="dashboard">
    ...
    <!-- 公众号运营 -->
    <view class="module-section" v-if="ssoVisible && hasPermission('menu.sso-wx')">
      <view class="section-title">💬 公众号运营</view>
      <view class="module-grid">
        <view class="module-item" v-if="hasPermission('menu.sso-wx')" @click="navigateTo('/pages/wechat/config')">
          <view class="module-icon">🔌</view>
          <view class="module-name">接入配置</view>
        </view>
        <view class="module-item" v-if="hasPermission('menu.sso-wx')" @click="navigateTo('/pages/wechat/menu')">
          <view class="module-icon">📱</view>
        ...
        <view class="module-item" v-if="hasPermission('menu.sso-wx')" @click="navigateTo('/pages/wechat/material')">
          <view class="module-icon">🖼️</view>
          <view class="module-name">素材库</view>
        </view>
        <view class="module-item" v-if="hasPermission('menu.sso-wx')" @click="navigateTo('/pages/wechat/article')">
          <view class="module-icon">📝</view>
...
import { getCourseList, getUserCourseList, getCourseProgressList } from '../../api/course.js'
import { getQuestionList } from '../../api/quiz.js'
import { getRecordList } from '../../api/points.js'
import { loadSiteConfig, isModuleVisible } from '../../utils/config-helper.js'
import { articleApi, productApi, caseApi, leadApi } from '../../api/website.js'
